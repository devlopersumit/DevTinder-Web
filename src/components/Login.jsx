        ...
        <div className="flex justify-center mt-14">
            <form className="max-w-96 w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-base-300 text-white" onSubmit={handleLogin} action="#" method="post">
                ...
                <div className="flex items-center w-full mt-10 bg-white border border-gray-300/80 h-12 rounded-full overflow-hidden pl-6 gap-2">
                    ...
                    <input type="email" placeholder="Email id" className="bg-transparent text-gray-500 placeholder-gray-500 outline-none text-sm w-full h-full" required value={email} onChange={(e) => setEmail(e.target.value)} />
                </div>
                ...
                <p className="text-gray-400 text-sm mt-3 mb-11">Don’t have an account? <a className="text-indigo-500" href="#">Sign up</a></p>
            </form>
        </div>
    )
};
